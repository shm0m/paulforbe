              ...
              >
                <div className="aspect-[3/4] overflow-hidden rounded-2xl bg-gray-200 relative mb-6 shadow-lg">
                  ...
                  <Image 
                    ...
                    className={`object-cover transition-transform duration-500 group-hover:scale-105 ${member.name === "Mylène" ? "object-[60%_center]" : "object-center"}`}
                    priority={index === 0}
                  />
                  
                  <div className="absolute inset-0 bg-gradient-to-t from-rothschild/90 via-rothschild/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6 z-20">
                    <div className="flex justify-center translate-y-4 group-hover:translate-y-0 transition-transform duration-300 text-white">
                      <Link href={`mailto:${member.email}`} className="p-3 bg-white/10 hover:bg-white/20 rounded-full transition-colors">
                        <Mail size={24} />
                      </Link>
                    </div>
                  </div>
